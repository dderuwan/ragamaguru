...
<script>
    ...
    function loadAppointments(type) {
        ...
        const url = `{{ route('mAppointments.byTypeAndDate', ['type' => ':type', 'date' => ':date']) }}`
            .replace(':type', type)
            .replace(':date', date);
                ...
                data.forEach((appointment, index) => {
                    ...
                    const row = `
                            <tr>
                                ...
                                <td>${visitDayText}</td>
                                <td>${appointment.medical_reason}</td>
                                ...
                                <td>
                                    <div class="action-icons">
                                        ...
                                        <a href="{{ route('customerMData', '') }}/${appointment.customer_id}" class="btn btn-info"><i class="fe fe-file-plus fe-16"></i></i></a>
                                        ${appointment.haveTreat === "Done" ? `
                                        <a href="{{ route('viewCustomerMTreat', '') }}/${appointment.id}" class="btn btn-warning">
                                            <i class="fe fe-eye fe-16"></i>
                                        </a>` : ''}
                                        <!-- .<a href="{{ route('mAppointments.printPreview', '') }}/${appointment.id}" class="btn btn-info"><i class="fa fa-print fe-16"></i></i></a> -->   
