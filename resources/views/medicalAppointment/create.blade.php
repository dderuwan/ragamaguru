  ...
  <div class="container-fluid">
    <div class="row justify-content-center pl-5 pr-5">
      <div class="col-12">
        <div class="row mb-2">
          <div class="col-md-6">
            <h2 class="page-title">New Medical Appointment</h2>
          </div>
        </div>
        @if (session('success'))
        ...
        <div class="card shadow mb-4 p-2 pl-3">
          <div class="card-body">
            <form action="{{route('mAppointments.store')}}" method="POST" enctype="multipart/form-data">
              @csrf
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{route('mViewBooking',$booking->id)}}" class="btn btn-primary btn-sm">
              ...
              <div class="form-row mt-1">
                ...
                <label for="medical_reason" style="color:black;">Medical Reason<i class="text-danger">*</i></label>
                  <select class="form-control" id="medical_reason" name="medical_reason" required>
                    ...
                    <option value="{{$medicalReason->id}}">{{$medicalReason->reason}}</option>
                    @endforeach
                  </select>
                  @error('medical_reason')
                  <p class="text-danger">{{ $message }}</p>
                  @enderror
                </div>
              </div>
