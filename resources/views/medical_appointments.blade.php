...
<body>
  ...
  <div class="hero1">
    <div class="hero-container">
      <div class="content1">
        <h2 id="content-title">Medical Appointments</h2>
      </div>
    </div>
  </div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card mt-4" id="step4" style="display: none;">
            <div class="card-body">
              <h4 class="card-title">Step 4: Confirmation</h4>
              <div class="form-group mb-3">
                <label for="medicalReason" class="form-label">Reason for session</label>
  ...
  <script>
    ...
    document.getElementById('submitBooking').addEventListener('click', function() {
      const mreason = document.getElementById('medicalReason').value;
      const mreasonmsg = document.getElementById('mreasonmsg');
      mreasonmsg.innerText = '';
      if (!mreason) {
        mreasonmsg.innerText = 'Please select a reason';
        return;
      }
      sendOtp();
    });
    ...
    function saveBooking() {
      ...
      let medicalReason = document.getElementById('medicalReason').value;
