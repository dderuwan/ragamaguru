    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <h2>Customer Medical Treatments Report</h2>
                    </div>
                </div>
                <p class="card-text"></p>
                <div class="row my-4">
                                ...
                                <table id="mydata" class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;">Treatments for Reason</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($treatment->free_treatments)
                                                @php
                                                $treatmentNames = \App\Models\MedicalTreat::whereIn('id', $treatment->free_treatments)->pluck('name')->toArray();
                                                @endphp
