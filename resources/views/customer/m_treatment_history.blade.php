                                    ...
                                    <table class="table table-bordered table-hover" style="background-color: #e6ffe6; color: #333;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$history->appointment->medicalReason->reason?? 'Not Defined'}}</td> 
                                                <td>
                                                    @if($history->free_treatments)
                                                    @php
                                                    $treatmentNames = \App\Models\MedicalTreat::whereIn('id', $history->free_treatments)->pluck('name')->toArray();
                                                    @endphp
