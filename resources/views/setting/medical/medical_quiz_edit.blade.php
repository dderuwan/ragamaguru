    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <h2 class="page-title">Medical Question Settings</h2>
                    </div>
                ...
                <div class="row my-4">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <h5 class="mb-2">Edit Medical Question</h5>
                                <form method="POST" action="{{ route('quiz.update', $quiz->id) }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="inputQuiz" name="quiz" value="{{ $quiz->quiz }}" placeholder="Add Question">
                                            @error('quiz')
