...
<main role="main" class="main-content">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">All Medical Treatments</h2>
                <p class="card-text"></p>
                <div class="card-header">

                    <button type="button" class="btn btn-primary float-end" onclick="window.location.href='{{ route('createMedicalTreatment') }}'">
                        Add Treatment
                    </button>
                </div>
                <div class="row my-4">
                                ...
                                <table class="table datatables" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Edit Button -->
                                                <a href="{{ route('editMedicalTreatment', $Treatment->id) }}" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editModal{{ $Treatment->id }}">
                                                    <i class="fas fa-edit"></i>
                                                </a>

                                                <!-- Delete Button -->

                                                 <button class="btn btn-danger btn-sm" onclick="confirmDelete({{ $Treatment->id }})"><i class="fe fe-trash"></i></button>
                                                <form id="delete-form-{{ $Treatment->id }}" action="{{ route('deleteMedicalTreatment', $Treatment->id) }}" method="POST" style="display:none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
