...
<head>
    ...
    <title>Medical Treatment Bill</title>
    <style>
        body {
...
<body>
    ...
    <div class="bill-container">
        ...
        <div class="section">
            ...
            <table>
                <tr>
                    ...
                    <td>{{$appointment->medicalReason->reason}}</td>
                </tr>
            </table>
        </div>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    @foreach ($ftreatments as $ftreatment)
                    <tr>
                        <td>{{ $ftreatment->name }}</td>
                        <td>
                            @if(is_array(json_decode($ftreatment->things_to_bring)))
                            {{ implode(', ', json_decode($ftreatment->things_to_bring)) }}
                            @else
                            N/A
                            @endif
                        </td>
        ...
        <!-- Section 4: Treatments and Amounts -->
        <div class="section">
            <h2>Additional Treatments & Amounts</h2>
            <table>
                <thead>
                    <tr>
    ...
    <script>
        ...
        window.onafterprint = function() {
            window.location.href = "{{ route('mAppointments.index') }}";
        };
    </script>
