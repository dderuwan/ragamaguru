            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="row align-items-center my-3">
                        <div class="col">
                            <h2 class="page-title">Medical Treatments</h2>
                        </div>
                        <div class="col-auto">
                            <a href="{{route('mAppointments.index')}}"><button type="button" class="btn btn-primary" data-toggle="modal">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-5">
                                            <form action="{{ route('updateMNextDay', $treatmentHistory->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                    ...
                                    <form action="{{route("saveMTreatPayment",$appointment->id)}}" method="POST">
                                        ...
                                        <table class="table table-bordered table-hover" style="background-color: #e6ffe6; color: #333;">
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                $treatments = \App\Models\MedicalTreat::whereIn('id', $treatmentHistory->treatments)->get();
